...
class StorageAdapter(
    ...
    ListAdapter<Storage, StorageAdapter.ProfileHolder>(object : DiffUtil.ItemCallback<Storage>() {
    ...
    inner class ProfileHolder(binding: ItemSotrageBinding) : RecyclerView.ViewHolder(binding.root) {
