...
class PowerSupplyAdapter(private val onItemClick: IOnItemClick) :
    ListAdapter<PowerSupply, PowerSupplyAdapter.ProfileHolder>(object : DiffUtil.ItemCallback<PowerSupply>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileHolder {
        return ProfileHolder(ItemPowerSupplyBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    inner class ProfileHolder(binding: ItemPowerSupplyBinding) : RecyclerView.ViewHolder(binding.root) {
