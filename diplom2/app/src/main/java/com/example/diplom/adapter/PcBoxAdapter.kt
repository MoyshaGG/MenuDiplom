...
class PcBoxAdapter (private val onItemClick: IOnItemClick) :
    ListAdapter<PcBox, PcBoxAdapter.ProfileHolder>(object : DiffUtil.ItemCallback<PcBox>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileHolder {
        return ProfileHolder(ItemPcboxBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    inner class ProfileHolder(binding: ItemPcboxBinding) : RecyclerView.ViewHolder(binding.root) {
